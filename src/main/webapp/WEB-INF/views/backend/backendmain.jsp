...
<<<<<<< HEAD
						...
						<td><a type="button" class="btn btn-outline-secondary"
							href="${pageContext.request.contextPath}/mvc/scholarship/backend/copy/${ scholarship.scholarshipId }">複製</a>
						</td>
						<td><a type="button" class="btn btn-outline-secondary"
							style="display: ${scholarship.isUpdated ? 'inlineblock' : 'inlineblock'}"
							href="${pageContext.request.contextPath}/mvc/scholarship/backend/copy/${ scholarship.scholarshipId }">
								${scholarship.isUpdated ? '上架中' : '未上架'}</a></td>
