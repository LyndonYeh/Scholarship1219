...
<body>
	<div class="d-flex justify-content-center  align-items-center vh-100 " class="">
		<form class="row g-3 needs-validation " novalidate method="post" action="./scholarmain.jsp">
			...
			<div class="">
				<label for="cfpassword" class="form-label">新密碼確認</label>
			...
			<div class="col-md-7">
				<label for="password" class="form-label">修改聯絡電話</label>
				<input type="password" class="form-control" id="password"
					name="password" value="" required>
				  <div class="invalid-feedback">請輸入聯絡電話</div>
			</div>
			<div class="col-md-7">
				<label for="password" class="form-label">輸入驗證碼</label>
			...
			<button type="button" class="btn btn-outline-danger">寄送驗證碼至信箱</button></div>
