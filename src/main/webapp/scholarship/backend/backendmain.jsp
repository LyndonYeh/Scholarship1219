...
<body>
	<tr>
		<td valign="top">
			...
			<h2>新增獎學金項目</h2>
			<!-- 名稱旁要有上傳檔案的按鈕 -->
				&emsp;獎學金名稱:&nbsp;<input type="text" id="sname" name="sname" placeholder="請輸入名稱" required />
				&emsp;開始日期:&nbsp; <input type="date" id="sdate" name="sdate"/>
				&emsp;結束日期:&nbsp; <input type="date" id="edate" name="edate" required /></p>
		...
		<table class="table table-warning">
			...
			<tbody>
				<tr>
					...
					<td>&nbsp;<button type="submit" id="pushconfirm" name="pushconfirm">確認</button></td>
				</tr>
